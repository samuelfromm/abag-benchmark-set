...
if len(sys.argv) < 6:
    print("Usage for AF2:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_pdb_file> <pae_cutoff> <dist_cutoff> <output_directory>")
    ...
    print("")
    print("Usage for AF3:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff>  <output_directory>")
    print("   python ipsae.py fold_aurka_tpx2_full_data_0.json  fold_aurka_tpx2_model_0.cif 10 10")
    print("")
    print("Usage for Boltz1:")
    print("   python ipsae.py <path_to_pae_npz_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff>  <output_directory>")
...
file_path =        os.path.join(outdir,os.path.split(path_stem)[1]) + ".txt"
file2_path =       os.path.join(outdir,os.path.split(path_stem)[1]) + "_byres.txt"
pml_path =         os.path.join(outdir,os.path.split(path_stem)[1]) + ".pml"
