...
OUTPUT_CSV_PATH="/home/sfromm/git/abag-benchmark-set/results/sampling_scores_noreplace/sampling_scores_noreplace_$PRESET.csv"  # Path to save the output results
