...
INPUT_CSV_PATH="/home/sfromm/git/abag-benchmark-set/data/scores/extra/scores_alphafold3_$PRESET.csv"        # Path to the input CSV file
OUTPUT_CSV_PATH="/home/sfromm/git/abag-benchmark-set/results/sampling_scores_extra/sampling_scores_alphafold3_$PRESET.csv"  # Path to save the output results
MAX_SAMPLE_SIZE=40                   # Maximum sample size
