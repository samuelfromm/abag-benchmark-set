...
OUTDIR="/proj/elofssonlab/users/x_safro/git/abag-benchmark-set/data/scores_ae/$RUNNAME/output/$PDBID"
SAMPLES_CSV="/proj/elofssonlab/users/x_safro/git/abag-benchmark-set/data/scores_ae/$RUNNAME/input/${PDBID}_samples_$RUNNAME.csv"
