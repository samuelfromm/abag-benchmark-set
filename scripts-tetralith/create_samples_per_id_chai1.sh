...
# Templates for paths
PDB_TEMPLATE="$MODELDIR/$RUNNAME/{ID}complex/model_{MODEL_NUM}_seed_{PRED_NUM}_${RUNNAME}.pdb" #cif 
FEATURES_TEMPLATE="$MODELDIR/$RUNNAME/{ID}complex/full_confidence_model_{MODEL_NUM}_seed_{PRED_NUM}_${RUNNAME}.json" #"$MODELDIR/$RUNNAME/{ID}complex/{ID}complex_data.json"
DATA_TEMPLATE="$MODELDIR/$RUNNAME/{ID}complex/full_confidence_model_{MODEL_NUM}_seed_{PRED_NUM}_${RUNNAME}.json"
