...
OUTDIR="/proj/berzelius-2021-29/users/x_safro/git/paper/abag-benchmark-set/data/scores_extra/$RUNNAME/output/$PDBID"
SAMPLES_CSV="/proj/berzelius-2021-29/users/x_safro/git/paper/abag-benchmark-set/data/scores_extra/$RUNNAME/input/${PDBID}_samples_$RUNNAME.csv"
SMKFILE="$BASEDIR/calculate_scores_extra.smk"
